...
-- Script de Estructura Completa para MySQL
-- =============================================
...
CREATE TABLE IF NOT EXISTS `proyectos_corte` (
    ...
    `material_ancho` int(11) NOT NULL,
    `material_alto` int(11) NOT NULL,
    `material_espesor` decimal(5,2) NOT NULL,
    ...
    `status` enum('Activo','Archivado') DEFAULT 'Activo',
    PRIMARY KEY (`id`),
    KEY `empresa_id` (`empresa_id`),
    KEY `usuario_id` (`usuario_id`),
